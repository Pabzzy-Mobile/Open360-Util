 ...
 * @property {string[]} following - List of channel IDs this User is following
 */
class UserData {
    type: UserDataTypes;
    active: boolean;
    ...
    empty() : boolean
    {
        return this.userId === "" && this.username === "" && this.email === "" && this.password === "" && this.salt === "" && this.displayName === "" && this.subscriptions === [] && this.following === [];
    }
}
